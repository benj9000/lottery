...
from lottery.application.repositories import TicketRepository
from lottery.configuration import TicketConfigProtocol
from lottery.domain.ticket import Lotto6aus49Pick, Ticket, TicketNumber
